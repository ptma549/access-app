...
import { JobVisitComponent } from 'app/entities/job-visit/job-visit.component';
...
describe('Component Tests', () => {
  describe('JobVisit Management Component', () => {
    let comp: JobVisitComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(JobVisitComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.jobVisits && comp.jobVisits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
