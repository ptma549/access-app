...
import { NumberComponent } from 'app/entities/number/number.component';
import { NumberService } from 'app/entities/number/number.service';
import { Number } from 'app/shared/model/number.model';

describe('Component Tests', () => {
  describe('Number Management Component', () => {
    let comp: NumberComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NumberComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.numbers && comp.numbers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
