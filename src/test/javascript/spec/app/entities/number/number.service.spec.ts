...
describe('Service Tests', () => {
  describe('Number Service', () => {
    ...
    let elemDefault: INumber;
    let expectedResult: INumber | INumber[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(NumberService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Number(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Number', () => {
        ...
        service.create(new Number()).subscribe(resp => (expectedResult = resp.body));
