...
export class PriorityComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.priorityService
      ...
      .subscribe(
        (res: HttpResponse<IPriority[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPriorities(): void {
    this.eventSubscriber = this.eventManager.subscribe('priorityListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPriority[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
