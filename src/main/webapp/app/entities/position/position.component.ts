...
export class PositionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.positionService
      ...
      .subscribe(
        (res: HttpResponse<IPosition[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPositions(): void {
    this.eventSubscriber = this.eventManager.subscribe('positionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPosition[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
