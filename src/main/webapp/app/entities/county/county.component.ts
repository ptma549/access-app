...
export class CountyComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.countyService
      ...
      .subscribe(
        (res: HttpResponse<ICounty[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICounty[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
